...
export const WN: React.FC<SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 81 81" {...props}>
      <Path
        d="M48 45.1c-3.3 1.6-7.2 1.9-11 .7l-.4-.1-.3.2c-.1.1-12 9.9-15.8 23.7l-.3.9H65L63.2 65v-.1c0-.1-.1-14.8-.1-23.8 0-16.9-7.6-25.6-15-28.6-3.7-1.4-9.2-2.5-12.4-2.5h-1.2l3.2 6.2-24.4 20.3 1 10.8 5 1.4 5.1-3.9H26l-4.3 4.5 1.1.4 6.7 1.9 5.5-6.8c3.5 1.5 7.7 1.3 12.5-.6 2.8-1.2 5.1-3.6 6.5-5.6-.9 2.8-3 5.1-6 6.5z"
        fill="#fff"
      />
      <Path d="m38 22.1-7.7 6.2c-.5.5-.6 1.3-.2 1.9.3.4.7.6 1.1.6.2 0 .4 0 .6-.1l9.1-3.6-2.9-5z" />
      <Path
        d="m38.7 70.7 17.7.3h8.5s-2.1-5.2-2.1-7.2V28.6c0 8.4-2.7 18-9.5 24.8C40.5 57 38.7 70.7 38.7 70.7zm-4.1-23.4 1.3-1.8 8.8.8 4.8-2.2 3.9-3.4 2.4-6.5c-.8-1.3-2.2-2.1-4-2.8-2 7.7-8.1 12.3-16.3 10.4-.4 1.1-.7 1.9-.7 1.9l-7 .3-5.8 4.8 7 4.5 5.6-6z"
        fill="#cfcecf"
      />
