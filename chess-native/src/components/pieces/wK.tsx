...
export const WK: React.FC<SvgProps> = (props) => {
  return (
    <Svg viewBox="0 0 81 81" {...props}>
      ...
      <Path
        d="M58 25.9c-6 0-9.1 2.6-10.6 4.1l-7 12.2-7-12.2C32 28.5 29 25.9 23 25.9c-9.4 0-14.9 7.7-14.9 15.3 0 8.6 3.7 11.5 8.6 21.7V71h47.6v-8.1c4.9-10.1 8.6-13.1 8.6-21.7 0-7.6-5.5-15.3-14.9-15.3z"
        fill="#fff"
      />
      <Path
        d="m35.3 32.8 5.2 10.7 5.2-10.7-3.1-11 7.9 2.4v-7.6l-7.9 1 1.7-7.3h-7.6l1.7 7.3-7.9-1v7.6l7.9-2.4z"
        fill="#fff"
      />
      <Path
        d="M64.7 27.4C71.8 40 58 58.6 45.9 59.9l19.4 2.6 6.6-13.4 1-9.9-1.7-5.2-2.6-3.6-3.9-3zm-31.1 2.7c1.1 5.4-1.6 14.6-5.4 20.5S17.7 61.4 17.7 61.4l22.8-1.6V42.6l-6.9-12.5z"
        fill="#cfcecf"
      />
      <Path
        d="M53.1 60.6v9.9H64v-7.6zm-3.6-42.9-1.3 2.8-7.1-.2 8.4 3.3h1zm-6.4-6.4L40.5 13v6.2l1.6-1zm-1.3 10.2v11.7l-1.3 7L45 34zm-1.9-.9h-9.4v3.6z"
        fill="#cfcecf"
      />
