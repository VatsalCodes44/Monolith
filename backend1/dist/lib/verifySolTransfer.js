import { Connection, SystemProgram, Keypair, clusterApiUrl, } from "@solana/web3.js";
...
export async function verifySolTransfer(network, signature, from) {
    ...
    for (const instruction of instructions) {
        ...
        if (instruction.accountKeyIndexes[0] === fromIdx &&
            ...
            if (tx.meta.preBalances[toIdx] == undefined || tx.meta.postBalances[toIdx] == undefined)
                throw new Error("error in parsing transaction");
